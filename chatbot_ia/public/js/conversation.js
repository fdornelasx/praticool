...
var ConversationPanel = (function () {
    ...
    function displayMessage(newPayload, typeValue) {
        ...
        if (newPayload.output && newPayload.output.text) {
            for (var i = 0; i < newPayload.output.text.length; i++) {
                sendMessage(newPayload.output.text[i], isUser?'right':'left');
            };
        }
    }
    ...
    function buildMessageDomElements(newPayload, isUser) {
        ...
        textArray.forEach(function (currentText) {
            if (currentText) {
                var messageJson = {
                    //'tagName' : 'div',          
                    //'classNames': ['bubble' , (isUser ? 'user' : 'watson')],
                    //'text' : currentText
                    // <div class='segments'>
                    'tagName': 'div',
                    'classNames': ['segments'],
    ...
    function scrollToChatBottom() {
        var scrollingChat = document.querySelector('#chat-body');
    ...
    function inputKeyDown(event, inputBox) {
        ...
        if (event.keyCode === 13 && inputBox.value) {
            ...
            sendMessage(inputBox.value, 'right');
